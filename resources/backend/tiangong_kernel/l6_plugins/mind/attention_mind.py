"""AttentionMindPlugin inert declaration and output skeleton."""
...
from .mind_projection import AttentionProjection, FocusPriorityScore


@dataclass(frozen=True)
class AttentionMindPlugin:
    declaration: MindPluginDeclaration = field(default_factory=lambda: MindPluginDeclaration(
        plugin_ref="mind:attention_mind",
        plugin_kind=MindPluginKind.ATTENTION,
        summary="L6 phase3 mind:attention_mind inert mind helper declaration.",
        output_kind_refs=("projection:l6_phase3_mind", "score:l6_phase3_mind", "suggestion:l6_phase3_mind"),
    ))
    primary_output: AttentionProjection = field(default_factory=AttentionProjection)
    secondary_output: FocusPriorityScore = field(default_factory=FocusPriorityScore)
