"""Disabled custom formula adapter reservation."""
...
def _descriptor() -> MathAdapterDescriptor:
    return build_math_adapter_descriptor(
        adapter_id="disabled.custom_formula_adapter",
        adapter_kind="custom_formula_adapter",
        adapter_name="Disabled Custom Formula Adapter",
        supported_model_domains=("custom_formula", "scoring", "forgetting"),
    )


@dataclass(frozen=True, slots=True)
class CustomFormulaAdapter:
    """Disabled stub for future custom formula profiles."""
