"""Disabled LLM judge adapter reservation."""
...
def _descriptor() -> MathAdapterDescriptor:
    return build_math_adapter_descriptor(
        adapter_id="disabled.llm_judge_adapter",
        adapter_kind="llm_judge_adapter",
        adapter_name="Disabled LLM Judge Adapter",
        supported_model_domains=("llm_judge", "adaptation_decision", "evolution_assessment"),
    )


@dataclass(frozen=True, slots=True)
class LLMJudgeAdapter:
    """Disabled stub for future model-judged assessments."""
