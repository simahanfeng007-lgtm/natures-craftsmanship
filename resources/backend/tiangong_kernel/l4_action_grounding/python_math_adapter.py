"""Disabled Python math adapter reservation."""
...
def _descriptor() -> MathAdapterDescriptor:
    return build_math_adapter_descriptor(
        adapter_id="disabled.python_math_adapter",
        adapter_kind="python_math_adapter",
        adapter_name="Disabled Python Math Adapter",
        supported_model_domains=("generic_math", "custom_formula"),
    )


@dataclass(frozen=True, slots=True)
class PythonMathAdapter:
    """Disabled stub for future Python formula execution."""
