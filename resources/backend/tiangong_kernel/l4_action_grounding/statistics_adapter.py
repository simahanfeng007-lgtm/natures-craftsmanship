"""Disabled statistics adapter reservation."""
...
def _descriptor() -> MathAdapterDescriptor:
    return build_math_adapter_descriptor(
        adapter_id="disabled.statistics_adapter",
        adapter_kind="statistics_adapter",
        adapter_name="Disabled Statistics Adapter",
        supported_model_domains=("statistics", "health", "resource_pressure"),
    )


@dataclass(frozen=True, slots=True)
class StatisticsAdapter:
    """Disabled stub for future statistical scoring."""
